export const SITE = {
  ...
  desc: "Where Tech meets Philosophy. Breaking systems, building tools, and thinking about why we do it.",
  title: "Glitched_Cat",
  ...
  dynamicOgImage: true,
  dir: "ltr", // "rtl" | "auto"
  lang: "en-GB", // html lang code. Set this empty and default will be "en"
